<div class="container-fluid">
  ...
  <?php } ?>
  <form class="site-form "  method ="post" id="addManufacture" action="<?php echo adm_base_url();?>/add_manufacture" >
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" placeholder="Name" name="manufacturer_name">
        </div>
      </div>
    </div>   	
     <hr>
