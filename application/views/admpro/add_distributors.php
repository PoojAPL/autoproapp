...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-24 col-md-24">
      ...
      <?php } ?>
      <form class="site-form " method ="post" action="<?php echo adm_base_url();?>/autopropad/save_distributors" enctype="multipart/form-data">
      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
             <input type="file" required="required" class="form-control" name="imagePath">
            </div>
          </div>
        </div>
        <div class="row">
