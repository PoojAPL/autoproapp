<div class="container-fluid">  
  ...
  <?php } ?>
  <form class="site-form" method ="post" id="add_key" action="<?php echo adm_base_url();?>/vehicles/save_vehicle_type" enctype="multipart/form-data">
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         ...
         <input type="text" class="form-control" placeholder="Vehicle Type" name="type" >
        </div>
      </div>
    </div> 
