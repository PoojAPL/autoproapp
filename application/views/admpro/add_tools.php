...
<div class="container-fluid">
  ...
  <?php } ?>
  <form class="site-form "  method ="post" id="addTool" action="<?php echo adm_base_url();?>/save_tool" enctype="multipart/form-data">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" placeholder="Name" name="tool_name">
        </div>
      </div>
    </div>    
    <div class="row">
        ...
        <div class="inputcol">
         <select class="form-control" name="manufacture">
            ...
            <?php foreach($getAllManufacturer as $manufacture){?>
            	<option value="<?php echo $manufacture['UUID'];?>"><?php echo $manufacture['Manufacturer_Name'];?></option>
            <?php } ?>
         </select>
        </div>
      </div>
    ...
    <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
             <input type="text" class="form-control" name="toolImage" id="someImageTagID" readonly="readonly" >
            </div>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" name="tool_note" class="form-control">
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" name="Useful_For" class="form-control">
        </div>
      </div>
    </div>
    <div class="row">
...
<script type="text/javascript">
  ...
  const ref = firebase.storage().ref('/tools-images/'+uuid+'');
