<div class="container-fluid">  
  ...
  <?php } ?>
  <form class="site-form" method ="post" id="add_images" action="<?php echo adm_base_url();?>/vehicles/update_obp_options" enctype="multipart/form-data">  
  ...
  <input type="hidden" name="id" value="<?php echo $id;?>" />  
        ...
        <div class="inputcol">
         <select class="form-control" name="Category_UUID" >
            ...
            <?php foreach($obp_option_categories as $type){
				if($obp_options_info[0]['Category_UUID'] == $type['UUID']){
					$selected = 'selected';
				}else{
					$selected = '';
				}
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="text" class="form-control" name="Default_Text" value="<?php echo $obp_options_info[0]['Default_Text'];?>">
        </div>
      </div>
    </div>  
    <div class="row">
      ...
      <div class="col-sm-20">
        <div class="inputcol">
         <?php foreach($get_image as $type){
			  if($obp_options_info[0]['Default_Image_UUID'] == $type['UUID']){
					$selected = 'checked';
				}else{
					$selected = '';
				}?>
         		<div class="obp_options_imgs">
            	<input type="radio" value="<?php echo $type['UUID'];?>" name="Default_Image_UUID" <?php echo $selected; ?> >
