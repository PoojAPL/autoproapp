...
<div class="container-fluid">
  ...
  <?php } ?>
  <form class="site-form " method ="post" action="<?php echo adm_base_url();?>/save_remote">  
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" /> 
      ...
      <div class="col-sm-10">
        <div class="inputcol">
           <select class="form-control selectRemoteType"  name="Remote_Type_UUID">
        ...
        <div class="inputcol shellData">
          ...
          <select class="form-control" name="Shell_UUID" id="Shell_UUID" >
            <option value="">Select Shell Key</option>
			   <?php			   	  
			   	  /*if( $getRemotesInfo[0]['Shell_UUID'] == ""){
					  $get_remote_shell_keys = get_remote_shell_keys_info($getRemotesInfo[0]['Remote_Type_UUID']);						
			 	  }else{
