...
<table class="table table-striped table-data mar0">
  <thead>
    <tr> 
    <th>Image</th>                 
      <th>Tool Type <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-bottom tools_sorting_by_type" data_id="DESC"  data-sort="tool_type"></a></th>
      <th>Manufacturer  <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> tools_sorting_by_manufacturer" data_id="<?php echo $sorting_id;?>"></a></th>
