...
<div class="container-fluid">
  ...
  <?php } ?>
  <form class="site-form" method ="post" id="AddMethods" action="<?php echo adm_base_url();?>/vehicles/update_tip_tricks">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
    <!--<h2 class="titleheadng">Add Model</h2>-->
      ...
      <input type="hidden" id="UUID" name="UUID" value="<?php echo $method_info[0]['UUID']?>" /> 
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
               <select type="text" class="form-control" placeholder="Title" name="Category">
                <option value="">Please select</option>
                <?php foreach ($tpi_trics_category as $value) {
                  if($value == $method_info[0]['Category']){
                    $selected = 'selected';
                  }else{
                    $selected = ''; 
                  }?>
