<?php 
    ...
    $all_vehciles = get_Firebase_vehicles_year_vehicleInfo1($start_from, $limit);
    //echo '--'.count($all_vehciles).'<br>';
                ...
                if($vehciles['Chip_Key_UUID'] ==""){
                    ...
                    for($i = 0; $i < count($chip_keys_array); $i++ ){
                        ...
                        /*------------- Key Shell ------------------------------------*/											  
                            ...
                            if($get_key_type[0]['Key_Type_Name'] !=""){
...
if( count($vehicle_info_array3) > 0){                
    ...
    //curl_setopt($cSession,CURLOPT_URL,"https://american-key.firebaseio.com/approved_images.json");
