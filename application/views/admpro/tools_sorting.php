...
<table class="table table-striped table-data mar0">
  <thead>
    <tr>  
    <th>Image</th>                
      <th>Tool Type <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-bottom tools_sorting_by_type" data_id="DESC"></a></th>
      ...
      <th>Name <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> tools_sorting" data_id="<?php echo $sorting_id;?>"></a></th>
       <th>Note</th>
       <th>Useful For</th>
      <th>Difficulty</th>
      <th>Products</th>
