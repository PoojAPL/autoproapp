...
<div class="container-fluid">
  ...
  <?php } ?>
  <form class="site-form" method ="post" id="AddMethods" action="<?php echo adm_base_url();?>/vehicles/save_tip_tricks">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
    ...
    <?php if($us_id != ""){
        ...
        $category = $get_user_submission_feedback[0]['category'];
      ...
      $tpi_trics_category = array('Car Door Unlocking','Code Locations','Key Programming','Lock Removal','OBD Port Location','Remote Programming',"Trunk Opening", "Lock Picking/Decoding","Other");?>
        <fieldset>
        ...
        <div class="row">
          <div class=" col-sm-4 ">
            <div class="labelcol">
              <label class="control-label">Tip/Trick Category</label>
            </div>
          </div>
          <div class="col-sm-10">
            <div class="inputcol">
               <select type="text" class="form-control" placeholder="Title" name="Category" value="<?php echo $title;?>">
                <option value="">Please select</option>
                <?php foreach ($tpi_trics_category as $value) {
                  if($category == $value){
                    $selected = 'selected';
                  }else{
                    $selected = '';
        ...
        <div class="row">
          <div class=" col-sm-4 ">
            <div class="labelcol">
              <label class="control-label">Tip/Trick Title</label>
            </div>
          </div>
          <div class="col-sm-10">
            <div class="inputcol">
        ...
        <div class="row">
          <div class=" col-sm-4 ">
            <div class="labelcol">
              <label class="control-label">Tip/Trick Content</label>
            </div>
          </div>
          <div class="col-sm-10">
        ...
        <div class="row">
          <div class="imageRow">
            ...
            <div class="col-sm-10">
              <div class="inputcol">
               <input type="text" class="form-control" name="Image_path[]" value="<?php echo $Images;?>" id="someImageTagID" readonly="readonly" >
              </div>
            </div>
            <div class="col-sm-2">
    ...
    <div class="col-md-12">
        ...
        <a href="<?php echo adm_base_url();?>/vehicles/tip_tricks" class="btn btn-danger">Cancel</a>
    </div>   
  </div>
   </form>
  </div>
...
<script type="text/javascript">
  ...
  const ref = firebase.storage().ref('/tip_tricks-images/'+uuid+'');
