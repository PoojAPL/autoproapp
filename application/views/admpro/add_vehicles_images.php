              ...
              <div class="inputcol">
                <label class="control-label">Selected Vehicles</label>
                 <select name="Vehicle_UUID[]" id="search_to" class="form-control" size="17" multiple="multiple">
                  <?php if($vehicle != ""){
                    $Vehicle_UUID_data = explode('__',$vehicle); ?>
                    <option value="<?php echo $vehicle;?>" selected><?php echo $Vehicle_UUID_data[0];?></option>
                  <?php } ?>
                 </select>
              </div>
            </div>
      ...
      <div class="col-sm-10">
        <div class="inputcol">
          ...
          <div class="usersResults">
           <select class="form-control" value="<?php echo $User_Email;?>"  name="User_UUID" id="search_select" >
