  ...
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
    <!--<h2 class="titleheadng">Add Model</h2>-->
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
               <input type="text" class="form-control" placeholder="Part Name" name="Part_Name">
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="inputcol">
               <select  class="form-control"  name="PartType_UUID">
                ...
                <?php foreach($results as $part_type){?>
               		<option value="<?php echo $part_type['UUID'];?>"> <?php echo $part_type['Name'];?></option>
                <?php } ?>
               </select>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
               <input type="text" class="form-control" placeholder="Part Image Url" name="Part_Image_Url">
            </div>
          </div>
        </div>
        <div class="row">
