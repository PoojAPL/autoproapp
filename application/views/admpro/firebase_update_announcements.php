    ...
    <div class="row">     
      <div class="col-sm-24">
        <div class="form-group addCodeSeries">          
          <a href="<?php echo adm_base_url();?>/announcements" class="btn btn-danger" >Back<<</a>        
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-24">
     ...
     <div class="site-form">
          <div class="table-responsive chips_data vehiclesData" style="overflow:visible"> 
            <?php 
              $data = json_encode($announcements); 
              //print_r($data);                               
              $options['auth'] = 'PomxyBl1zWE3q6fUAlVL6BhpntIWGwFmD47NlWbe';            
              $cSession = curl_init();        
              curl_setopt($cSession,CURLOPT_URL,"https://autoproapp2017.firebaseio.com/announcements.json?". http_build_query($options));
