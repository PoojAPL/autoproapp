...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-24 col-md-24">
      ...
      <?php } ?>
      <form class="site-form" method ="post" action="<?php echo adm_base_url();?>/save_accessories" enctype="multipart/form-data">
      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
          ...
          <div class="col-sm-10">
            <div class="inputcol">
             <select required="required" class="form-control" name="type">
               <?php foreach (accessories_type() as $value) {
                   if($accessories_info[0]['type'] == $value['accessories_Type_Name']){
                       $selected = 'selected';
                   }else{
                    $selected = '';
                   }?>
                 <option <?php echo $selected;?>><?php echo $value['accessories_Type_Name'];?></option>
               <?php }?>
             </select>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
            <input type="text" required="required" class="form-control" name="name" value="<?php echo $accessories_info[0]['name'];?>">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="inputcol">
             ...
             <input type="hidden" name="copy_image" value="<?php echo $accessories_info[0]['image'];?>">
            </div>
          </div>
          <div class="col-sm-8">
            <?php if( $accessories_info[0]['image'] != ""){ ?>
                <img src="<?php echo asset_url();?>/images/<?php echo $accessories_info[0]['image'];?>" width="30px">
            <?php } ?>
          </div>  
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
             <input type="text"class="form-control" name="part" value="<?php echo $accessories_info[0]['part'];?>">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
             <input type="text" class="form-control" name="products" value="<?php echo $accessories_info[0]['products'];?>">
            </div>
          </div>
        </div>
        <fieldset>
              ...
              <div class="inputcol">
                <label class="control-label">Selected Vehicles</label>
                 <select name="parts_vehicle[]" id="search_to" class="form-control" size="17" multiple="multiple">
                   <?php
                    if($accessories_info[0]['vehicles'] != ""){ 
                      $vehicles_UUIDs = explode(',', $accessories_info[0]['vehicles']);
     ...
     <hr>
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="<?php echo adm_base_url();?>/accessories" class="btn btn-danger">Cancel</a> </div>
        </div>
      </form>
    </div>
  </div>
