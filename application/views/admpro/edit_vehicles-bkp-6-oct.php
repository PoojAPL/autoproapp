    ...
    <div class="col-sm-24 col-md-24">
      ...
      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
        ...
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
              <select class="form-control" name="Remote_UUID[]" multiple="multiple" style="height:auto;">
              	<option value="">Select Remote </option>
                <?php 
				$programm_array = explode(',',$getVehiclesInfo[0]['Remote_UUID']); 
        ...
        <div class="row">
          <div class=" col-sm-4 ">
            <div class="labelcol">
              <label class="control-label">Remote Head Key  </label>
            </div>
          </div>
          <div class="col-sm-10">
            <div class="inputcol">
              <select class="form-control" name="RHK_UUID[]" multiple="multiple" style="height:auto;">
                ...
                <?php 
				$programm_array = explode(',',$getVehiclesInfo[0]['RHK_UUID']); 
        ...
        <div class="row">
          <div class=" col-sm-4 ">
            <div class="labelcol">
              <label class="control-label">Smart Key</label>
            </div>
          </div>
          <div class="col-sm-10">
            <div class="inputcol">
              <select class="form-control" name="SmartKey_UUID[]"  multiple="multiple" style="height:200px;">
                ...
                <?php 
				$programm_array = explode(',',$getVehiclesInfo[0]['SmartKey_UUID']); 
        ...
        <legend>Advanced Diagnostics</legend>
            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                <div class="inputcol">
                  <input type="text" class="form-control" name="PIN_Read" value="<?php echo $getVehiclesInfo[0]['MVP_PIN_Read'];?>" />
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                <div class="inputcol">
                  <input type="text" class="form-control" name="MVP_Notes" value="<?php echo $getVehiclesInfo[0]['MVP_Notes'];?>" />
                </div>
              </div>
            </div>
        </fieldset>
