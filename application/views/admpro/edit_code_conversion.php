<div class="container-fluid">
  <div class="row">
    <div class="col-sm-24 col-md-24">
      ...
      <?php } ?>
      <form class="site-form " method ="post" action="<?php echo adm_base_url();?>/update_code_conversion">
      ...
      <input type="hidden" name="id" value="<?php echo $id;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <a href="<?php echo adm_base_url();?>/code_series_list" class="btn btn-danger">Cancel</a> </div>
        </div>
      </form>
    </div>
  </div>
