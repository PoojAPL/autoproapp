...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-24 col-md-24">
      ...
      <?php } ?>
      <form class="site-form " method ="post" id="AddRetainerForm" action="<?php echo adm_base_url();?>/save_retainer">
      ...
      <!--<h2 class="titleheadng">Add Model</h2>-->
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
              <input type="text" class="form-control" placeholder="Name" name="Retainer_Name">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
              <input type="text" class="form-control" placeholder="" name="Retainer_Image_Url">
            </div>
          </div>
        </div>
        <hr>
