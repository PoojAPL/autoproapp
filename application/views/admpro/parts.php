<div id="right-container">
  <div class="site-form form-inline">
    <div class="row">    	
      <div class="col-sm-24">
        <div class="form-group addCodeSeries"> <a href="<?php echo adm_base_url();?>/add_parts" class="btn btn-danger"  title="Add New Part">Add New Part</a> </div>
      </div>
    </div>
  </div>
  <div class="row">
             	...
             	<tbody>
                	<?php foreach($results as $value){?>
                    	<tr>
                            ...
                            <td>
                              <a href="<?php echo adm_base_url();?>/edit_parts/<?php echo $value['id'];?>" type="button" class="btn btn-success" >Edit</a> 
                              <a href="<?php echo adm_base_url();?>/copy_parts/<?php echo $value['id'];?>" type="button" class="btn btn-info" >Copy</a>
