...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-24 col-md-24">
      ...
      <?php } ?>
      <form class="site-form " method ="post" action="<?php echo adm_base_url();?>/update_admin_announcement">
      ...
      <input type="hidden" id="UUID" name="UUID" value="<?php echo $announcements_info[0]['UUID'];?>" /> 
      <input type="hidden" name="id" value="<?php echo $id;?>">
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">	
              <input type="text" class="form-control" name="Title" required="required" value="<?php echo $announcements_info[0]['Title'];?>" >
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="inputcol">
             <select class="form-control select_announcements_type" name="Type" >
               ...
               foreach ($announcements_type as $value) {
                  if($value == $announcements_info[0]['Type']){
                    $selected = 'selected';
                  }else{
                    $selected = '';
                  }
        ...
        <?php if( $announcements_info[0]['Type'] == 'View With Version Update'){
          $version_class = '';
        }else{
          $version_class = 'hide';  
        }
        ?>
        <div class="row versionRow <?php echo $version_class;?> ">
          <div class=" col-sm-4 ">
            <div class="labelcol">
          ...
          <div class="col-sm-10">
            <div class="inputcol"> 
              <input type="text" class="form-control" name="Version" value="<?php echo $announcements_info[0]['Version'];?>" >
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
             <input type="text" class="form-control" name="Image_path[]" id="someImageTagID" readonly="readonly" value="<?php echo $announcements_info[0]['Image'];?>" >
            </div>
          </div>
        ...
        <?php if($announcements_info[0]['Active'] =='Yes'){
            $checked = 'checked';
          }else{
            $checked = '';
          }
          ...
          <div class="col-sm-10">
            <div class="inputcol"> 
              <label class="checkbox-inline">
                <input type="checkbox" data-toggle="toggle" data-on="Enabled" data-off="Disabled" <?php echo $checked;?> name="Active">
              </label>
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">  
              <input type="number" class="form-control" name="Priority" value="<?php echo $announcements_info[0]['Priority'];?>" >
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
              <input type="'text'" class="form-control" id="prchaseDate" name="Expiration" value="<?php echo $announcements_info[0]['Expiration'];?>" >
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-10">
            <div class="inputcol">
              <textarea class="form-control"  name="Message" ><?php echo $announcements_info[0]['Message'];?></textarea>
            </div>
          </div>
        </div>
        <hr>
