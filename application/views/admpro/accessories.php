      ...
      <div class="col-sm-6">
        <form method="post" id="globalSearchKyes">
            <div class="form-group">                     
                  ...
                  <button type="submit" class="btn btn-primary custom-button" name="search" value="accessories">Search</button>
            </div>
        </form>
      </div>
      <div class="col-sm-18">
        <div class="form-group addCodeSeries">          
          <a href="<?php echo adm_base_url();?>/add_accessories" class="btn btn-danger">Add Accessories</a>        
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="table-responsive chips_data">
            <table class="table table-striped table-data mar0">
			  ...
			  foreach($results as $value){?>
                    <tr>					                     
                        <td>
                            <a  href="<?php echo adm_base_url();?>/edit_accessories/<?php echo $value['id'];?>" type="button" class="btn btn-success" >Edit</a>   
                            <a  href="javascript:void(0)" onclick="DeleteChipsFunction(<?php echo $value['id'];?>, '<?php echo adm_base_url();?>/delete_accessories/')" type="button"class="btn btn-danger" >Delete</a>
                            <a  href="<?php echo adm_base_url();?>/copy_accessories/<?php echo $value['id'];?>" type="button" class="btn btn-info" >Copy</a> 
                        </td>
