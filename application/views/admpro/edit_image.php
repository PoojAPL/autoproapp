<div class="container-fluid">  
  <div class="row">
   ...
   <?php } ?>
  <form class="site-form" method ="post"  action="<?php echo adm_base_url();?>/update_image" enctype="multipart/form-data">
  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>" />
    ...
    <div class="row">
      ...
      <div class="col-sm-10">
        <div class="inputcol">
         <input type="file" class="form-control" name="Filename" ><?php echo $image_info[0]['Filename'];?>
        </div>
      </div>
    </div> 
    <div class="row">
        ...
        <div class="inputcol">
         <select class="form-control" name="Image_Type_UUID" >
            ...
            <?php foreach($image_types as $type){
				if($image_info[0]['Image_Type_UUID'] == $type['UUID']){
					$selected = 'selected';
				}else{
					$selected = '';
				}
