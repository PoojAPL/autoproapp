...
?><table class="table table-striped table-data mar0">
  <thead>
    <tr> 
      ...
      <th>Images</th>
      <th>Score
          <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-<?php echo $angle;?> tips_tricks_sorting" data_id="<?php echo $sorting_id;?>" data-col="Score"></a>
      </th>                                    
