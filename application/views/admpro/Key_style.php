    ...
    <div class="row">
      ...
      <div class="col-sm-24">
        <div class="form-group addCodeSeries">          
          <a href="<?php echo adm_base_url();?>/addKeyStyle" class="btn btn-danger"  title="Sign Out">Add New Key Style</a>        
        </div>
      </div>
    </div>
  </form>
          ...
          <div class="table-responsive make_users chips_data">
            <table class="table table-striped table-data mar0">
              <thead>
                <tr>
                  <th> Name 
                   <a href="javascript:void(0)" type="button" class="glyphicon glyphicon-triangle-bottom key_style_sorting" data-by="Key_Style_Name" data_id="DESC"></a>
                  </th>
