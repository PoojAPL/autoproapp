...
<!--<script src="<?php echo asset_url(); ?>admin/js/icheck.js"></script>-->
...
<script src="<?php echo asset_url(); ?>admin/js/jquery.form.js"></script>
<script src="<?php echo asset_url(); ?>admin/js/jquery.cookie.min.js"></script>

<script src="<?php echo asset_url(); ?>admin/js/custom.js?v=<?php echo time();?>"></script>
